        ...
        if(!loading&&this.tops){
            ...
            for(let i=0;i<this.tops.length;i++){
                ...
                tops.push(<TableRow selectable={false} key={"top"+i} style={this.tops[i].blocks===this.blocks?HighLightStyle:{}} >
                    ...
                    <TableRowColumn  style={FixedWidthStyle}><span style={{verticalAlign:"middle"}}>{this.tops[i].blocks}×</span><img src={Global.getCDNURL("media/title-beta.png")} style={{height:"24px",verticalAlign:"middle"}} /></TableRowColumn>
